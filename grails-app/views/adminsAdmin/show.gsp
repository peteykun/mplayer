...
<html>
	...
	<body>
		<div id="show-admin" class="content scaffold-show" role="main">
			...
			<g:form url="[id: adminInstance.id, controller:'adminsAdmin', action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" controller="adminsAdmin" action="edit" id="${adminInstance.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
